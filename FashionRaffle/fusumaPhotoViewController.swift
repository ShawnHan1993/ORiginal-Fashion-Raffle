...
class fusumaPhotoViewController: UIViewController, FusumaDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var picDescription: UITextView!
  ...
  //  @IBOutlet weak var brandLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        picDescription.layer.cornerRadius = 5
        
        comfirm.layer.cornerRadius = 5
        //comfirm.layer.borderColor = UIColor.
        //comfirm.layer.borderWidth = 1
        //picDescription.layer.borderColor = UIColor.lightGray.cgColor
        //picDescription.layer.borderWidth = 2
